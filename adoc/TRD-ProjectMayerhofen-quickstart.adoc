...
Adding the Fortinet deployment same workflow as with the normal SUSE SAP automation project, you only need to enable “with fortinet” to benefit from the additional installation of the Fortinet Fabric.
...
Whne Cloud Shell is started the first time you can select between "Bash" and "Powershell". Please use "Bash"
